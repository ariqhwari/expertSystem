                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="table-responsive pricing pt-2">
                                                ...
                                                $query = "SELECT penyakit_id, nama_penyakit FROM penyakit";
                                                ...
                                                <table id="my-table" class="table mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo $row['penyakit_id']; ?></td>
                                                            <td><?php echo $row['nama_penyakit']; ?></td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <span class="d-flex align-items-center h5 mb-0"
                                                                        id="dropdownMenuButton<?php echo $row['penyakit_id']; ?>"
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end"
                                                                        aria-labelledby="dropdownMenuButton<?php echo $row['penyakit_id']; ?>"
                                                                        style="">
