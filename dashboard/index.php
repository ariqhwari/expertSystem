        ...
        <main class="main-content">
            <div class="position-relative iq-banner">
                ...
                <div class="conatiner-fluid content-inner mt-n5 py-0">
                    <div class="row">
                        <div class="col-md-12 col-lm-8">
                            <div class="row row-cols-10">
                                <ul class="p-0 m-12 mb-12 swiper-wrapper">
                                    <li class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="700">
                                        <div class="card-body">
                                            <div>
                                                <p>Sistem pakar Penyakit Paru-Paru dengan metode certainty
                                                    factor adalah sebuah
                                                    sistem pakar yang dirancang untuk membantu dalam diagnosis
                                                    dan penanganan
                                                    penyakit paru-paru. Metode certainty factor digunakan untuk
                                                    mengukur tingkat
                                                    keyakinan atau kepastian dalam penilaian sebuah hipotesis
                                                    atau kesimpulan
                                                    berdasarkan bukti atau informasi yang ada.
                                                </p>
                                            </div>
                                            <div>
                                                <p>Dalam sistem pakar Penyakit Paru-Paru dengan metode certainty
                                                    factor, basis
                                                    pengetahuan terdiri dari aturan-aturan yang menghubungkan
                                                    gejala-gejala penyakit
                                                    dengan kemungkinan penyakit yang mungkin terjadi. Setiap
                                                    aturan memiliki
                                                    certainty factor (CF) yang menunjukkan tingkat keyakinan
                                                    pakar terhadap aturan
                                                    tersebut. CF dapat bernilai antara -1 hingga 1, dengan nilai
                                                    positif menunjukkan
                                                    keyakinan dan nilai negatif menunjukkan ketidakpercayaan.
                                                </p>
                                            </div>
                                        </div>
                                    </li>
                ...
                <footer class="footer">
                    <div class="footer-body">
                        <ul class="left-panel list-inline mb-0 p-0">
                            <li class="list-inline-item"><a href="../dashboard/extra/privacy-policy.php">Privacy
                                    Policy</a>
                            </li>
                            <li class="list-inline-item"><a href="../dashboard/extra/terms-of-service.php">Terms of
                                    Use</a>
                            </li>
                        </ul>
