                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header pb-3">
                                            <h3 class="block-title">Gejala</h3>
                                            <?php
                                            // Koneksi ke database
                                            $dbServer = 'localhost';
                                            $dbUser = 'ariq';
                                            ...
                                            // Memasukkan data gejala ke dalam array
                                            $gejala = array();
                                            ...
                                            mysqli_close($conn);
                                            ?>
                                            <form id="diagnosaForm" action="proses_diagnosa.php" method="POST">
                                                <h4>Pilih Gejala:</h4>
                                                <?php foreach ($gejala as $row) : ?>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="gejala[]"
                                                        value="<?php echo $row['gejala_id']; ?>"
                                                        id="gejala_<?php echo $row['gejala_id']; ?>">
                                                    <label class="form-check-label"
                                                        for="gejala_<?php echo $row['gejala_id']; ?>">
                                    ...
                                    var checkboxes = form.querySelectorAll('input[name="gejala[]"]');
                                    var submitButton = form.querySelector('button[type="submit"]');

                                    // Tambahkan event listener pada setiap checkbox
                                    checkboxes.forEach(function(checkbox) {
                                        checkbox.addEventListener('change', updateDiagnosaButton);
                                    });

                                    // Panggil fungsi saat halaman dimuat untuk memastikan status tombol diagnosa disetel dengan benar
                                    updateDiagnosaButton();

                                    // Fungsi untuk mengupdate status tombol diagnosa
                                    function updateDiagnosaButton() {
                                        ...
                                        // Aktifkan atau nonaktifkan tombol diagnosa berdasarkan jumlah pilihan yang dipilih
                                        if (checkedCount < 4 || checkedCount === 0) {
