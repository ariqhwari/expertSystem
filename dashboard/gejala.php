                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="table-responsive gejala pt-2">
                                                <?php
                                                // Koneksi ke database
                                                $dbServer = 'localhost';
                                                $dbUser = 'ariq';
                                                ...
                                                // Query untuk mengambil data dari tabel gejala
                                                $query = "SELECT gejala_id, nama_gejala FROM gejala";
                                                ...
                                                <table id="my-table" class="table mb-0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo $row['gejala_id']; ?></td>
                                                            <td><?php echo $row['nama_gejala']; ?></td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <span class="d-flex align-items-center h5 mb-0"
                                                                        id="dropdownMenuButton<?php echo $row['gejala_id']; ?>"
                                                                    ...
                                                                    <div class="dropdown-menu dropdown-menu-end"
                                                                        aria-labelledby="dropdownMenuButton<?php echo $row['gejala_id']; ?>"
                                                                        style="">
                                                                        <a class="dropdown-item" href="#">
                                                                            <svg width="20" viewBox="0 0 24 24"
                                                                                ...
                                                                                <path
                                                                                    ...
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round"></path>
                                                                                <path d="M14.2936 12.9141H9.39355"
                                                                                    stroke="currentColor"
                                                                                    stroke-width="1.5"
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round"></path>
                                                                                <path d="M11.8442 15.3639V10.4639"
                                                                                    stroke="currentColor"
                                                                                    stroke-width="1.5"
                                                                                    stroke-linecap="round"
                                                                                    stroke-linejoin="round"></path>
