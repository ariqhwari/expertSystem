        ...
        <aside class="sidebar sidebar-default sidebar-white sidebar-base navs-rounded-all ">
            <div class="sidebar-header d-flex align-items-center justify-content-start">
                <a href="index.php" class="navbar-brand">
                    ...
                    <h4 class="logo-title">Sistem Pakar</h4>
                </a>
                    ...
                    <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                            ...
                            <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link active" href="#">
                                        ...
                                        <span class="item-name">Diagnosa</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="sub-nav collapse" id="sidebar-auth" data-bs-parent="#sidebar-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="auth/sign-in.php">
                                        <i class="icon">
                                            <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                                <g>
                                                    <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <li class="nav-item dropdown">
                                    <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <div class="caption ms-3 d-none d-md-block ">
                                            <p class="mb-0 caption-sub-title">User</p>
                                        </div>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item" href="app/user-profile.php">Profile</a>
                                        </li>
                                        <li><a class="dropdown-item" href="app/user-privacy-setting.php">Privacy
                                                Setting</a>
                                        </li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><a class="dropdown-item" href="auth/sign-in.php">Logout</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header pb-3">
                                            <h3 class="block-title">Hasil Diagnosa</h3><br>
                                            <?php
                                            // Koneksi ke database
                                            $dbServer = 'localhost';
                                            $dbUser = 'root';
                                            ...
                                            // Memeriksa apakah ada gejala yang dipilih
                                            if (isset($_POST['gejala']) && is_array($_POST['gejala']) && count($_POST['gejala']) >= 4) {
                                                // Mendapatkan gejala yang dipilih dari formulir
                                                $selectedGejala = $_POST['gejala'];

                                                // Mengubah array gejala menjadi string dengan pemisah koma
                                                $gejalaString = implode(',', $selectedGejala);

                                                // Query untuk mengambil data aturan dan nama gejala dari basis pengetahuan
                                                $query = "SELECT nama_gejala FROM gejala WHERE gejala_id IN ($gejalaString)";

                                                $result = mysqli_query($conn, $query);

                                                // Menyimpan gejala yang dipilih ke dalam array
                                                $gejalaDipilih = array();
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    $gejalaDipilih[] = $row['nama_gejala'];
                                                }

                                                // Memeriksa apakah ada minimal 4 gejala yang dipilih
                                                if (count($gejalaDipilih) >= 4) {
                                                    // Query untuk mengambil data aturan dan nama penyakit dari basis pengetahuan
                                                    $query = "SELECT a.gejala_id, a.penyakit_id, a.mb, a.md, g.nama_gejala, p.nama_penyakit
                  FROM aturan a
                  JOIN gejala g ON a.gejala_id = g.gejala_id
                  JOIN penyakit p ON a.penyakit_id = p.penyakit_id
                  WHERE a.gejala_id IN ($gejalaString)";

                                                    $result = mysqli_query($conn, $query);

                                                    // Menyimpan data aturan ke dalam array
                                                    $aturan = array();
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        $aturan[] = $row;
                                                    }

                                                    // Menghitung Certainty Factor untuk setiap penyakit
                                                    $hasilDiagnosa = array();
                                                    foreach ($aturan as $row) {
                                                        $gejalaID = $row['gejala_id'];
                                                        $penyakitID = $row['penyakit_id'];
                                                        $namaGejala = $row['nama_gejala'];
                                                        $namaPenyakit = $row['nama_penyakit'];
                                                        $mb = $row['mb'];
                                                        $md = $row['md'];

                                                        // Menentukan Certainty Factor untuk gejala yang dipilih
                                                        if (in_array($gejalaID, $selectedGejala)) {
                                                            if (!isset($hasilDiagnosa[$penyakitID]['cf'])) {
                                                                $hasilDiagnosa[$penyakitID]['nama_penyakit'] = $namaPenyakit;
                                                                $hasilDiagnosa[$penyakitID]['gejala'][] = $namaGejala;
                                                                $hasilDiagnosa[$penyakitID]['cf'] = $mb;
                                                            } else {
                                                                $cf1 = $hasilDiagnosa[$penyakitID]['cf'];
                                                                $cf2 = $mb;

                                                                // Menggunakan rumus kombinasi MB
                                                                $cf_combined = ($cf1 + $cf2 * (1 - $cf1));

                                                                // Menggunakan rumus kombinasi MD
                                                                $md_combined = ($md + $md * (1 - $md));

                                                                // Menggunakan rumus Certainty Factor
                                                                $hasilDiagnosa[$penyakitID]['cf'] = $cf_combined - $md_combined;
                                                            }
                                                        }
                                                    }
                                                    ...
                                                    // Menampilkan gejala yang dipilih oleh pengguna
                                                    ...
                                                    // Menampilkan hasil diagnosa berdasarkan Certainty Factor
                                                    if (count($hasilDiagnosa) > 0) {

                                                        // Mengurutkan hasil diagnosa berdasarkan nilai CF tertinggi
                                                        arsort($hasilDiagnosa);

                                                        echo "<br>Daftar Penyakit yang Relevan:<br>";
                                                        echo "<div class='table-responsive'>";
                                                        echo "<table class='table table-bordered'>";
                                                        echo "<thead><tr><th>No</th><th>Nama Penyakit</th><th>CF</th></tr></thead>";
                                                        echo "<tbody>";

                                                        $no = 1;
                                                        foreach ($hasilDiagnosa as $penyakit) {
                                                            $namaPenyakit = $penyakit['nama_penyakit'];
                                                            $cf = $penyakit['cf'];
                                                            echo "<tr><td>$no</td><td>$namaPenyakit</td><td>$cf</td></tr>";

                                                            // Menyimpan penyakit dengan CF tertinggi
                                                            if (!isset($penyakitTertinggi) || $cf > $penyakitTertinggi['cf']) {
                                                        ...
                                                        // Mendapatkan hasil akhir dari penyakit dengan CF tertinggi (Bronkiektasis)
                                                        $namaPenyakitTertinggi = $penyakitTertinggi['nama_penyakit'];
                                                        $cfTertinggi = $penyakitTertinggi['cf'];

                                                        echo "<br>Hasil Akhir<br>";
                                                        echo "Penyakit: $namaPenyakitTertinggi<br>";
                                                        echo "Kemungkinan terbesar terkena penyakit: $namaPenyakitTertinggi (CF: $cfTertinggi)<br>";
                                                        // Tombol Kembali
                                                        echo "<br>";
                                                        echo "<a href='diagnosa.php' class='btn btn-primary'>Kembali</a>";
                                                    } else {
                                                        echo "Tidak ditemukan penyakit yang sesuai dengan gejala yang Anda pilih.";
                                                    }
                                                } else {
                                                    echo "Anda harus memilih minimal 4 gejala.";
                                                }
                                            } else {
                                                echo "Silakan pilih minimal 4 gejala.";
                                            }
                                            ?>
                                    ...
                                    <footer class="footer">
                                        <div class="footer-body">
                                            <ul class="left-panel list-inline mb-0 p-0">
                                                <li class="list-inline-item"><a href="extra/privacy-policy.php">Privacy
                                                        Policy</a>
                                                </li>
                                                <li class="list-inline-item"><a href="extra/terms-of-service.php">Terms
                                                        of Use</a>
                                                </li>
                                            </ul>
